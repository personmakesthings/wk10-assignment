...
export default function Home() {
  ...
  const content002 = (
    <div className="bounds">
      ...
      <p>This is the sole utility the package provides. How it is implemented is left entirely to the developer. It can be used to create anything, from a simple, single movable element, to sprawling Kanban boards.</p>
